...
public class Peaklass extends Poomine {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\nTere tulemast mängima poomismängu! Sisestage tähti kuni arvate ära sõna või kaotate!");

        while(true) {                                       //while-tsükkel kuni mäng katkeb
            prindiMees(valesti);

            if (valesti >= 6) {
                System.out.println("Kaotasid! Valitud sõna oli " + ANSI_RED + sõna + ANSI_RESET + "!");
                break;
            }
            ...
            System.out.print("Arva, mis sõna võiks olla: ");
            if (klaviatuur.nextLine().equals(sõna)){ //kui kirjutati õige sõna, lõpetab mängu
                System.out.println("Võitsid!");
                break;
            }
            else {
                System.out.println("Arvasid valesti! Proovi edasi!");
            }
            System.out.println("Oled vale tähte pakkunud " + valesti + " korda");
        }
    }
}
